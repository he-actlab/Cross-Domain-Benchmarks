...
fptype BlkSchlsEqEuroNoDiv( fptype sptprice,
                            ...
                            fptype time, int otype, float timet, fptype* N1,
fptype* N2)
{
    fptype OptionPrice;
...
double normalize(double in, double min, double max, double min_new, double
max_new)
{
...
int main (int argc, char **argv)
{
    ...
    char *inputFile = "data/blackscholesTest_200K.data";
    char *outputFile = "data/bsout.data";
...
&data[loopnum].strike, &data[loopnum].r, &data[loopnum].divq, &data[loopnum].v,
&data[loopnum].t, &data[loopnum].OptionType, &data[loopnum].divs,
...
#define LINESIZE 64
    ...
    sptprice = (fptype *) (((unsigned long long)buffer + PAD) & ~(LINESIZE -
1));
